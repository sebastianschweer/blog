...
For this test I choose ....


## The results

I started with the candidate `t2.micro`. Unfortunately, after the installation the script ran into the following error
...
Anyways, let’s proceed with the results, first in plain numbers:

```{r echo=FALSE}
benchmark_df <- 
data.frame( instance_class = c(“t2”,
            instance_name  = c(“micro”,
            price          = c(0,
            duration_bm    = c(NA,
            loss_bm        = c(NA,
            accuracy_bm    = c(NA,    
