...
![Here we go!](SCREENSHOT_START_INSTANCE)
...
![Hooray, all the hard work pays off!](/img/screenshot_finish_button.png)
...
![Green lights indicate the instance runs harmoniously.](/img/screenshot_finish_button.png)

Hopefully, you haven't forgotten your password (check [Step 2c](#step2c)):

![The login to a world of wonder.](/img/screenshot_finish_button.png)
...
![Locate "Create Image" in the menu of "Instance Settings"](/img/screenshot_finish_button.png)
...
!["5 volumes": make sure that they are not in-use, since storage may also cost after some initial period](https://res.cloudinary.com/dlprdrxib/image/upload/v1516310583/screenshot_terminateinstance_el4vj8.png)
...
[^2]: A rough estimate. Maybe only gazillions.